...
--}}          <li class="nav-item">
           ...
           <li class="nav-item " id="menu_lections">
                <a class="nav-link" href="{{ route("panel.lections.index") }}">
                    <i class="material-icons">library_books</i>
                    <p>{{ trans('panel.menu.lections') }}</p>
                </a>
            </li>
            <li class="nav-item " id="menu_tests">
                <a class="nav-link" href="{{ route("panel.test.index") }}">
                    <i class="material-icons">library_books</i>
                    <p>{{ trans('panel.menu.tests') }}</p>
                </a>
            </li>
            <li class="nav-item " id="menu_tests">
                <a class="nav-link" href="{{ route("panel.chat.index") }}">
                    <i class="material-icons">library_books</i>
                    <p>{{ trans('panel.menu.chat') }}</p>
                </a>
            </li>
            <li class="nav-item " id="menu_tests">
                <a class="nav-link" href="{{ route("panel.map.index") }}">
                    <i class="material-icons">library_books</i>
